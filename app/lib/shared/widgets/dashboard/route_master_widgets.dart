...
class DashboardGreeting extends StatelessWidget {
  const DashboardGreeting({
    super.key,
    required this.name,
    this.performanceNote = 'Your sales performance is up 12% this week.',
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        Text(performanceNote, style: theme.textTheme.muted),
      ],
    );
  }
}
                ...
                children: [
                  if (badge != null)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: badgeColor ?? RouteMasterColors.onTrackGreen(context),
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 10,
                          fontWeight: FontWeight.w600,
                          color: badgeTextColor ?? RouteMasterColors.onTrackText(context),
                        ),
                      ),
                    ),
                  Text(
